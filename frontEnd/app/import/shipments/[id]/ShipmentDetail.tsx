  ...
  return (
    <section className={styles.section}>
      <PageHeader
        ...
        backHref="/import/shipments"
        backLabel="Shipments"
        breadcrumbs={[
          { label: "Dashboard", href: "/import/dashboard" },
          { label: "Shipments", href: "/import/shipments" },
      ...
      <Card id="section-on-shipment" className={`${styles.card} ${styles.sectionScrollTarget}`}>
        ...
        {(isUpdatingShipment
          ? (editShipmentMethod.trim() || detail.shipment_method || "").toLowerCase() === "sea"
          : (detail.shipment_method || "").toLowerCase() === "sea") && (
          <>
                  ...
                  <div className={styles.linkedPoCardSummary}>
                    ...
                    <div className={styles.linkedPoCardMain}>
                      <div className={styles.linkedPoCardTitleRow}>
                        <Link href={`/import/po/${po.intake_id}`} className={styles.poLink}>
                          {po.po_number}
                        </Link>
                        {items.length > 0 && (

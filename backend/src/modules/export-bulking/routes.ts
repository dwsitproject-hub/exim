...
exportBulkingRoutes.get(
  "/shipments/documentation-assignees",
  authMiddleware,
  requirePermission(P.ASSIGN_EXPORT_BULKING_DOCUMENTATION),
  ctrl.listDocumentationAssignees,
);
...
exportBulkingRoutes.patch("/shipments/:id", authMiddleware, requirePermission(P.UPDATE_EXPORT_OPERATIONS, P.UPDATE_EXPORT_BULKING), ctrl.update);
exportBulkingRoutes.patch(
  "/shipments/:id/documentation-assignment",
  authMiddleware,
  requirePermission(P.ASSIGN_EXPORT_BULKING_DOCUMENTATION),
  ctrl.assignDocumentation,
);
...
exportBulkingRoutes.delete("/shipments/:id/shipping-instructions/:siId", authMiddleware, requirePermission(P.UPDATE_EXPORT_DOCUMENTATION, P.UPDATE_EXPORT_BULKING), ctrl.deleteSI);

/* ───── invoices ───── */
exportBulkingRoutes.get("/shipments/:id/invoices", authMiddleware, requirePermission(P.VIEW_EXPORT_BULKING), ctrl.listInvoices);
exportBulkingRoutes.post("/shipments/:id/invoices", authMiddleware, requirePermission(P.UPDATE_EXPORT_DOCUMENTATION, P.UPDATE_EXPORT_BULKING), ctrl.createInvoice);
exportBulkingRoutes.patch("/shipments/:id/invoices/:invId", authMiddleware, requirePermission(P.UPDATE_EXPORT_DOCUMENTATION, P.UPDATE_EXPORT_BULKING), ctrl.updateInvoice);
exportBulkingRoutes.post(
...
exportBulkingRoutes.post("/shipments/:id/packing-lists", authMiddleware, requirePermission(P.UPDATE_EXPORT_DOCUMENTATION, P.UPDATE_EXPORT_BULKING), ctrl.createPL);
exportBulkingRoutes.patch("/shipments/:id/packing-lists/:plId", authMiddleware, requirePermission(P.UPDATE_EXPORT_DOCUMENTATION, P.UPDATE_EXPORT_BULKING), ctrl.updatePL);
exportBulkingRoutes.post(
...
exportBulkingRoutes.get(
  ...
  authMiddleware,
  requirePermission(P.VIEW_EXPORT_DOCUMENTATION, P.VIEW_EXPORT_BULKING),
  docCtrl.listDocuments,
);
exportBulkingRoutes.post(
  "/shipments/:id/documents",
  authMiddleware,
  requirePermission(P.UPDATE_EXPORT_DOCUMENTATION, P.UPDATE_EXPORT_BULKING, P.UPLOAD_DOCUMENT),
  uploadSingle,
